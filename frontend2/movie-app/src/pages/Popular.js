...
export default function Popular() {
    ...
    //const [alertStatus, setAlertMessage] = useState(null);


    //let [error, setError] = useState(null);

    //this function triggers when the add button is clicked. It adds the user score to the movie.
    function popularMovies() {
      ...
      axios.get(`${url}/popular`+"?page="+pageNum, {})
